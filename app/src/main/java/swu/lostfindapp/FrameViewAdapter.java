...
public class FrameViewAdapter extends BaseAdapter {
    // Adapter에 추가된 데이터를 저장하기 위한 ArrayList
    private ArrayList<FragmentItem> DateItemList = new ArrayList<FragmentItem>() ;

    // ListViewAdapter의 생성자
    public FrameViewAdapter() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView dateTextView = (TextView) convertView.findViewById(R.id.textView) ;


        // Data Set(listViewItemList)에서 position에 위치한 데이터 참조 획득
        FragmentItem listViewItem = DateItemList.get(position);
